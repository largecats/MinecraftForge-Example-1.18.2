package net.largecats.examplemod.entity.custom;
...
public class SeekerEntity extends Animal implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public SeekerEntity(EntityType<? extends Animal> entityType, Level level) {
